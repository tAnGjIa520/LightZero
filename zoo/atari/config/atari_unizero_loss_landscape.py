...
def main(env_id='PongNoFrameskip-v4', seed=0):
    ...
    # ==============================================================
    # Lightweight configuration for quick loss landscape visualization
    collector_env_num = 8  # Increased from 2 to collect more data in parallel
    game_segment_length = 20
    evaluator_env_num = 1
    num_simulations = 10
    max_env_step = int(5e4)  # Increased from 1e4 to collect more data
    batch_size = 32
    num_unroll_steps = 5
    ...
    atari_unizero_config = dict(
        ...
        policy=dict(
            ...
            # train_start_after_envsteps=0, # TODO: only for debug. /mnt/shared-storage-user/tangjia/unizero/LightZero/zoo/atari/config/atari_unizero_loss_landscape.py
