...
def train_muzero(
    ...
    assert create_cfg.policy.type in ['efficientzero','efficientzero_v2' ,'muzero', 'muzero_context', 'muzero_rnn_full_obs', 'sampled_efficientzero', 'sampled_muzero', 'gumbel_muzero', 'stochastic_muzero'], \
    ...
    elif create_cfg.policy.type == 'efficientzero_v2':
        from lzero.mcts import EfficientZeroV2GameBuffer as GameBuffer
