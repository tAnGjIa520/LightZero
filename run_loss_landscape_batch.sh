...
CKPT_BASE_DIR="/mnt/shared-storage-user/tangjia/unizero/LightZero/mnt/shared-storage-user/tangjia/rftinfra/tangjia/ckpt/Pong_uz_brf0.02-rbs160-rp0.75_nlayer2_numsegments-8_gsl20_rr0.25_Htrain10-Hinfer4_bs64_seed0/ckpt"

# Config script path
CONFIG_SCRIPT="/mnt/shared-storage-user/tangjia/unizero/LightZero/zoo/atari/config/atari_unizero_loss_landscape.py"

# Base log directory
BASE_LOG_DIR="data_lz/loss_landscape_batch"
